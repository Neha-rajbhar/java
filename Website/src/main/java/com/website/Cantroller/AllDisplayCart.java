...
/**
 * Servlet implementation class AllDisplayCart
 */
@WebServlet("/AllDisplayCart")
public class AllDisplayCart extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 response.setContentType("text/html");  
	       ...
	       // out.println("<a href='register.jsp'>Employee</a>");  
	        ...
	        List<Products> list=ConnectionProvider.getAllEmployees();  
