...
.cards .card{
background: linear-gradient(45deg,#40739e,#f5f6fa);
padding: 20px;
display: flex;
align-items: center;
justify-content: space-between;
...
<span class="title"><h4>User-home</h4></span>
</a>
</li>
<li>
<a href="Cart.jsp">
...
<span class="title"><h4>Change Password</h4></span>
</a>
</li>

<li>
<a href="UserChangeDetail?id=<%=r.getId()%>">
<span class="icon"><i class="fa fa-user" aria-hidden="true"></i></i></span>
<span class="title"><h4>User Details</h4></span>
</a>
</li>
...
<span class="icon"><i class="fa fa-shopping-cart" aria-hidden="true"></i></i></span>
<span class="title"><h4>Shop</h4></span>
</a>
</li>
